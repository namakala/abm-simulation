...
\(\lambda_{\mathrm{ero}}\) is stress erosion rate
(\(\text{STRESS\_EROSION\_RATE}\)); \(m_{\mathrm{ero}}\) is the erosion
multiplier (ASSUMPTION\_STRESS\_AFFECT\_EROSION\_MULTIPLIER);
\(\beta_{ra}\) is the resource--affect coupling
(ASSUMPTION\_RESOURCE\_AFFECT\_COUPLING); and
\(S_t, R_t, \mathfrak{R}_t\) are current stress, resources, and
resilience. The peer influence indicator selects the first
\(k_{\text{influence}}\) neighbors.
...
with mean degree \(WS\_k\) and rewiring probability \(WS\_p\).
...
starts from a neutral point: no pairwise association exceeds 0.20 in
...
Mean perceived stress (PSS-10 = 13.533 ± 0.760, CV 5.6\%, range
12.34--16.56) demonstrates low variability indicative of effective
homeostatic regulation. Resilience (0.439 ± 0.015, CV 3.4\%) shows
uniform coping capacity across the population, and affect (-0.060 ±
0.016, CV 27.3\%) exhibits controlled mood variation near neutral.
Elevated resource levels (0.338 ± 0.005) indicate effective resource
management through social network dynamics, and moderate stress (0.241 ±
0.055) relative to baselines suggests effective stress mitigation.
...
\midrule
avg\_pss10 & PSS-10 across agents & 13.533 ± 0.760 & Stable stress perception with moderate elevation\\
avg\_resilience & Resilience level & 0.439 ± 0.015 & Uniform coping capacity across the population\\
avg\_affect & Affect (valence) & -0.060 ± 0.016 & Controlled mood variation near neutral\\
coping\_success\_rate & Coping success rate & 0.742 ± 0.045 & Reliable coping outcomes maintaining homeostasis\\
avg\_resources & Psychological resources & 0.338 ± 0.005 & Stable resource levels supporting resilience\\
\addlinespace
avg\_stress & Current stress level & 0.241 ± 0.055 & Variable patterns within bounded ranges\\
avg\_challenge & Challenge appraisal & 0.499 ± 0.015 & Balanced appraisal pattern\\
avg\_hindrance & Hindrance appraisal & 0.501 ± 0.015 & Balanced appraisal pattern\\
avg\_consecutive\_hindrances & Hindrance sequence length & 4.263 ± 0.765 & Occasional stress streaks but stable overall\\
 & Challenge–hindrance diff. & -0.003 ± 0.030 & Centered near zero, indicating equilibrium\\
\bottomrule
\end{tabular}
...
variation range from 1.4\% (resource levels) to 27.3\% (affect),
indicating tight population-level regulation. Balanced
challenge--hindrance appraisals (challenge 0.499 ± 0.015, hindrance
0.501 ± 0.015) imply neutral cognitive processing and effective
appraisal mechanisms, and the consistent coping success rate (0.742 ±
0.045) across all agents validates the model's capacity to simulate
...
\toprule
  & Variable & Mean ± SD & Interpretation\\
\midrule
pss10 & PSS-10 per agent-step & 13.533 ± 4.709 & Variable stress levels with realistic range\\
resilience & Resilience level & 0.439 ± 0.198 & Diverse adaptive capacities\\
affect & Emotional state & -0.060 ± 0.282 & Variable patterns around neutral\\
resources & Psychological resources & 0.338 ± 0.031 & Fluctuating resource capacity\\
current\_stress & Stress intensity & 0.241 ± 0.196 & Variable patterns within bounds\\
\addlinespace
stress\_controllability & Controllability perception & 0.839 ± 0.166 & Diverse agency experiences\\
stress\_overload & Overload perception & 0.139 ± 0.143 & Diverse capacity challenges\\
consecutive\_hindrances & Hindrance streak length & 3.466 ± 3.839 & Variable patterns observed\\
\bottomrule
\end{tabular}
...
population-level stability (CVs from 1.4\% to 27.3\%) and
individual-level heterogeneity (CVs from 34.8\% to 470.6\%) exemplifies
the dual nature of the modeled system. Individual agents experience
significant fluctuations in stress (0.241 ± 0.196, CV 81.4\%),
resilience (0.439 ± 0.198, CV 45.2\%), and affect (-0.060 ± 0.282). Its
large CV reflects a mean near zero on the \([-1, 1]\) scale. The SD of
0.282 indicates moderate dispersion, but dividing by a near-zero mean
...
controllable (0.839 ± 0.166) and rarely overwhelming (0.139 ± 0.143),
capturing the cognitive appraisal diversity that drives individual
adaptation strategies. Hindrance streaks remain bounded (3.466 ± 3.839,
maximum 30.2), demonstrating the system's capacity to prevent
...
Each block contributes its own metric family: perception adds
challenge/hindrance appraisal, activation adds coping success,
interaction adds social support exchange, allocation adds resource
regeneration, and buffering adds buffering strength and stress
depletion. Empty cells mark metrics whose block is not yet active. Stage
7 runs through \texttt{simulate.py}, which does not export the
allocation and buffering phase metrics, so those cells remain empty.

\begin{table}

\caption{\label{tab:cum-stage-metrics}Cumulative building-block metrics by stage (means over the run)}
\centering
\begin{tabular}[t]{llllllll}
\toprule
  & Stage 1 & Stage 2 & Stage 3 & Stage 4 & Stage 5 & Stage 6 & Stage 7\\
\midrule
PSS-10 & 15.96 & 15.96 & 16.18 & 18.28 & 18.22 & 17.89 & 13.77\\
Current stress & 0.425 & 0.425 & 0.715 & 0.798 & 0.798 & 0.762 & 0.237\\
Affect & 0.026 & 0.026 & -0.92 & -0.982 & -0.982 & -0.981 & -0.064\\
Resilience & 0.459 & 0.459 & 0.297 & 0.068 & 0.068 & 0.208 & 0.447\\
Resources & 0.493 & 0.493 & 0.116 & 0.115 & 0.315 & 0.311 & 0.338\\
\addlinespace
Stress prevalence & 0.03 & 0.03 & 0.03 & 0.09 & 0.1 & 0.11 & 0.01\\
Challenge appraisal & n/a & 0.499 & 0.502 & 0.498 & 0.498 & 0.498 & 0.499\\
Hindrance appraisal & n/a & 0.501 & 0.498 & 0.502 & 0.502 & 0.502 & 0.501\\
Coping success rate & n/a & n/a & 0.457 & 0.349 & 0.35 & 0.407 & 0.742\\
Support exchange rate & n/a & n/a & n/a & 0.297 & 0.297 & 0.685 & 0.007\\
\addlinespace
Regeneration & n/a & n/a & n/a & n/a & 0.366 & 0.366 & n/a\\
Buffering strength & n/a & n/a & n/a & n/a & n/a & 0.03 & n/a\\
\bottomrule
\end{tabular}
\end{table}

The build-up shows how each mechanism shifts the population metrics.
Stage 7 -- the complete model -- is the configuration reported in the
model-level and agent-level tables above; its final-day population state
and agent heterogeneity are examined in the next section.
...
positive correlation with affect (0.26), a moderate negative correlation
with stress (-0.42), and a moderate negative correlation with PSS-10
(-0.47). In contrast, stress shows a moderate positive correlation with
PSS-10 (0.50), up from an essentially zero baseline association (0.03),
