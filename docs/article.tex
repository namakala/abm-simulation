...
\subsubsection{Full model (stage 7)}\label{full-model-stage-7}

Stage 7 runs the complete production pipeline. The final-day population
state summarises the emergent equilibrium of all blocks combined.

\begin{table}

\caption{\label{tab:cum-stage7-final}Full-model population state on the final day (stage 7)}
\centering
\begin{tabular}[t]{ll}
\toprule
Metric & Final-day value\\
\midrule
PSS-10 & 13.770\\
Resilience & 0.447\\
Affect & -0.064\\
Resources & 0.338\\
Current stress & 0.237\\
\addlinespace
Stress prevalence & 0.010\\
Coping success rate & 0.704\\
Challenge appraisal & 0.505\\
Hindrance appraisal & 0.495\\
\bottomrule
\end{tabular}
\end{table}

Agent-level heterogeneity persists within this stable population: the
mean and standard deviation of individual trajectories on the final day,
computed directly from the full model's exported agent data, show
substantial within-population dispersion.

\begin{table}

\caption{\label{tab:cum-stage7-agent}Individual heterogeneity within the full model, final day (stage 7)}
\centering
\begin{tabular}[t]{llrr}
\toprule
  & Variable & Mean & SD\\
\midrule
pss10 & PSS-10 & 13.770 & 4.640\\
resilience & Resilience & 0.447 & 0.205\\
affect & Affect & -0.064 & 0.275\\
resources & Resources & 0.338 & 0.033\\
current\_stress & Current stress & 0.237 & 0.185\\
\bottomrule
\end{tabular}
\end{table}
