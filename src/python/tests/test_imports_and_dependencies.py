...
from src.python.stress_utils import StressEvent, ThresholdParams, AppraisalWeights
...
class TestModuleImports:
    ...
    def test_all_modules_importable(self):
        ...
        modules_to_test = ["config", "affect_utils", "stress_utils", "math_utils", "agent", "model"]
